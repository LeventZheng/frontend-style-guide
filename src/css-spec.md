...
> from baidu https://github.com/ecomfe/spec/blob/master/css-style-guide.md
...
[8 SASS](#user-content-8-%E5%85%BC%E5%AE%B9%E6%80%A7)


## 1 前言

CSS 作为网页样式的描述语言，在网页上一直有着广泛的应用。本文档的目标是使 CSS 代码风格保持一致，容易被理解和被维护。
...
#### [强制] 如无必要，不得为 `class` 选择器添加元素选择器进行限定。
...
```css
/* centering <article class="page featured"> horizontally and highlight featured ones */
<article class="page featured"> horizontally and highlight featured ones</article>
article {
  margin: 5px;
...
webpack打包会自动转成缩写形式，所以在编码时与设计保持统一，不需要缩写
